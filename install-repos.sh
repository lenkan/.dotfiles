...
install_gpg "https://packages.cloud.google.com/apt/doc/apt-key.gpg" "cloud.google.gpg"
...
echo "deb [arch=$arch signed-by=$gpgdir/cloud.google.gpg] https://packages.cloud.google.com/apt cloud-sdk main" | sudo tee /etc/apt/sources.list.d/google-cloud-sdk.list
